...
import { Card, Row, Col, Button, Typography, Space, Empty, Modal, message, Popconfirm } from 'antd';
import { PlusOutlined, EditOutlined, DeleteOutlined, EnvironmentOutlined } from '@ant-design/icons';
import { useAuth } from '../../../context';
import { useRouter } from 'next/navigation';
import { useGetAddressesQuery, useAddAddressMutation, useUpdateAddressMutation, useDeleteAddressMutation } from '@data-access/api';
                            ...
                            <Card
                                actions={[
                                    ...
                                    <Popconfirm
                                        ...
                                        onConfirm={() => address.id && handleDeleteAddress(address.id)}
                                        okText="Evet"
                                        cancelText="Hayır"
                                    >
                                        <Button
