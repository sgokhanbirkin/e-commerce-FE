                ...
                <Col span={12}>
                    <Form.Item
                        ...
                        rules={[
                            ...
                            { pattern: /^\d{5}$/, message: 'Geçerli bir posta kodu girin (5 haneli)' }
                        ]}
                    >
            ...
            <Row gutter={16}>
                <Col span={12}>
                    <Form.Item
                        ...
                        label="Ülke"
                        rules={[
                            { required: true, message: 'Lütfen ülke seçin' }
                        ]}
                    >
                ...
                <Col span={12}>
                    <Form.Item
                        ...
                        rules={[
                            ...
                            { pattern: /^[+]?[\d\s\-\(\)]{10,}$/, message: 'Geçerli bir telefon numarası girin' }
                        ]}
                    >
