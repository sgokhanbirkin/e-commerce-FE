...
import { Card, Button, List, Typography, Spin, Alert, message, InputNumber, Space, Divider } from 'antd';
import { DeleteOutlined, ShoppingCartOutlined } from '@ant-design/icons';
import { useRemoveFromCartMutation, useUpdateCartItemMutation } from '@data-access/api';
...
export const Basket: React.FC<BasketProps> = ({
    ...
    const [updateCartItem, { isLoading: updateLoading }] = useUpdateCartItemMutation();
                ...
                renderItem={(item) => (
                    ...
                    >
                                ...
                                <div style={{
                                    ...
                                    <img
                                        ...
                                        onError={(e) => {
                                            ...
                                            target.parentElement!.innerHTML = '<div style="display: flex; align-items: center; justify-content: center; height: 100%; color: #999; font-size: 12px;">No Image</div>';
                                        }}
                                    />
                                </div>
                            }
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                            <div>
                                <Text strong>${(item.variant?.price || item.product.price).toFixed(2)}</Text>
                            </div>
                            <div>
                                <Space>
                                    <Text>Qty:</Text>
