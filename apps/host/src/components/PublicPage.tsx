...
const PublicPageComponent: React.FC<PublicPageProps> = ({ title = 'Public Page' }) => {
  return (
    <div style={{ padding: '2rem' }}>
      ...
      <div style={{
        ...
        <p>This page is accessible to everyone, including unauthenticated users.</p>
        <p>If you're already logged in, you would be redirected to the dashboard.</p>
      </div>
      ...
      <div style={{ marginTop: '2rem' }}>
        ...
        <ul>
          <li><a href="/login" style={{ color: '#1890ff' }}>Login Page</a></li>
          <li><a href="/register" style={{ color: '#1890ff' }}>Register Page</a></li>
          <li><a href="/" style={{ color: '#1890ff' }}>Home Page</a></li>
        </ul>
      </div>
    </div>
  );
