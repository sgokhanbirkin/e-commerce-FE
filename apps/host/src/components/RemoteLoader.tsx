    ...
    useEffect(() => {
        const loadRemoteComponent = async () => {
            try {
                ...
                const remoteModule = await import(/* webpackIgnore: true */ `${remoteName}${moduleName}`);
                ...
                console.error(`Failed to load remote component from ${remoteName}${moduleName}:`, err);
                setError(`Failed to load ${remoteName} component. Please try again later.`);
            } finally {
                setLoading(false);
            }
        };
